...
from utils.dataset_and_transform_generate import dataset_and_transform_generate
...
def load_attack_result(
    ...
    if all(key in load_file for key in ['model_name',
        ...
        clean_setting.dataset_path = save_path[:save_path.index('results')] + clean_setting.dataset_path[clean_setting.dataset_path.index('data'):]
